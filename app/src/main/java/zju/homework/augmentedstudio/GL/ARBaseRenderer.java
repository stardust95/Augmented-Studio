...
import zju.homework.augmentedstudio.Shaders.VideoBackgroundShader;
...
public class ARBaseRenderer {
    ...
    void initRendering()
    {
        vbShaderProgramID = Util.createProgramFromShaderSrc(VideoBackgroundShader.VB_VERTEX_SHADER,
    ...
    public void renderVideoBackground()
    {
        ...
        Util.checkGLError("Rendering of the video background failed");
    }
